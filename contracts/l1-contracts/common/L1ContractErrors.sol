...
// 0xa1ec1876
error InvalidMessageRoot(
  bytes32 expectedMessageRoot, bytes32 providedMessageRoot
);
// 0xde4c0b96
...
// 0x688c63e5
error PrecommitmentMismatch(
  uint256 batchNumber, bytes32 expected, bytes32 found
);
// 0x9b48e060
